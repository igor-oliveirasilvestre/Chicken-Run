...
def main(video_path, yolo_model):
    ...
    while True:
        ...
        for result in results_from_tracker:
            ...
            cvzone.putTextRect(img, f' {"pó"}', (max(0, x1), max(35, y1)),
...
if __name__ == "__main__":
    ...
    parser.add_argument('--video', type=str, default='data/video.mp4', help='path to the video file')
    parser.add_argument('--model', type=str, default='model/yolov8l.pt', help='path to the YOLO model')
